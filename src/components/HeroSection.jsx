            ...
            <div className="relative w-full max-w-md mx-auto">
              ...
              >
                <img
                  ...
                  alt="Ritik Trivedi"
                  className="relative z-10 rounded-full border-4 border-white/50 dark:border-white/20 shadow-custom-lg glass-effect object-cover aspect-square w-full max-w-md"
                />
              </motion.div>
            </div>
          </motion.div>
